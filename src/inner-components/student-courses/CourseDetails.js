        ...
        <div className='course-container'>
            <div className='course-content'>
                ...
                <div className='course-card'>
                    ...
                    <p>Anurudda Abesinghe - <Link className="emails">anuruddha.a@sliit.lk</Link></p>
                </div>
                <div className='course-card'>
                    ...
                    <p>Chamith Jayasinghe - <Link className="emails">chamith.j@sliit.lk</Link></p>
                </div>
                <div className='course-card'>
                    ...
                    <p>Rushira ManikkaArachchi - <Link className="emails">ruchira.m@sliit.lk</Link></p>  
                </div>
            </div>
        </div>
    )
